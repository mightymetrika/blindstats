-- Remove the final unused local variable from request_unblinding().
-- No behavior change. This follow-up migration is required because the
-- previously deployed migration is immutable.
